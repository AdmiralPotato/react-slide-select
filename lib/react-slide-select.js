...
var SlideSelect = React.createClass({
	...
	createTransition: function createTransition(targetValues, duration, interpolationMethod) {
		var slider = this;
		var startValues = {};
		var propertyName, startTime;
		interpolationMethod = interpolationMethod || function (k) {
			return k;
		};
	...
	render: function render() {
		...
		var slideSelectProps = {
			...
			onScroll: function onScroll(syntheticScrollEvent) {
