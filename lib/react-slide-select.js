...
/***/ function(module, exports, __webpack_require__) {
	...
	var SlideSelect = React.createClass({
		...
		getRelativeScrollDirection: function getRelativeScrollDirection(x) {
			var slider = this;
		...
		handleTouchStart: function handleTouchStart(syntheticTouchEvent) {
			var slider = this;
			if (slider.state.useScrollSnap) {
		...
		getAbsoluteXFromRelativeTouch: function getAbsoluteXFromRelativeTouch(touch) {
			var slider = this;
			return slider.state.startX + (slider.state.touchStartX - touch.clientX);
		},
		handleTouchMove: function handleTouchMove(syntheticTouchEvent) {
		...
		handleTouchEnd: function handleTouchEnd(syntheticTouchEvent) {
			var slider = this;
			if (slider.state.useScrollSnap) {
				var touch = slider.getTouchDataByStateId(syntheticTouchEvent);
				if (touch) {
